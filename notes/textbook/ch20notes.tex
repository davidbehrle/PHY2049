    ...
    \begin{tikzpicture}
        \node[mybox,text=fg1](box){
            \begin{minipage}{0.95\textwidth}
                Two protons are 3.6 nm apart. Find the elctric field at a point between them, 1.2 nm from one of the protons. Then find the force on an electron at this point.
                \begin{center}
                    \begin{tikzpicture}
